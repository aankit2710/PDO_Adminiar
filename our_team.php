...
require_once('includes/config/db_config.php');
	...
	try
  	{
  		$stmt = $db_con->prepare("SELECT * FROM our_team WHERE user_id=:user_id");  
			...
			<div class="content-header row">
				<div class="content-header-left col-12 mb-2 mt-1">
					<div class="row breadcrumbs-top">
						<div class="col-12">
							<h5 class="content-header-title float-left pr-1 mb-0">Our Team</h5>
					...
					<div class="row">
						<div class="col-4">
					        ...
					        <div class="card-header">
					          <h4 class="card-title">Add Team From Here</h4>
					          <hr/>
					        </div>
				                            ...
				                            <table class="table zero-configuration table-bordered">
			                                    ...
			                                    <?php
				                                    ...
				                                    <tr>
				                                        ...
				                                        <td><?=$designation?></td>
				                                        <td>
				                                        	<a href="edit_team.php?id=<?=$member_id?>" class="btn btn-outline-primary btn-sm mr-1 mb-1">Edit</a>
				                                        	<button type="submit" class="btn btn-outline-danger btn-sm mr-1 mb-1 remove" name="delete" id="<?=$member_id?>">Delete</button>
				                                        </td>
				                                    </tr>
				                                    <?php $i++; } } else { ?>
				                                	<tr>
				                                        <td colspan="7" class="text-center">No Members Available Yet!</td>
				                                    </tr>
				                                    <?php }?>
				                            </table>
				                        </div>
				...
				swal({
					...
					preConfirm: function() {
						return new Promise(function(resolve) {
							$.ajax({
								url: "ajax/insert-team-async.php",
								method:'POST',
								data: formData,
								contentType: false,
								cache: false,
		...
		$(".remove").click(function(){
			...
			swal({
				...
				preConfirm: function() {
					return new Promise(function(resolve) {
						$.ajax({
							url: "ajax/delete-team-async.php",
							method:'POST',
							data: {id:id},
							dataType: 'json',
							success: function (jSon)
