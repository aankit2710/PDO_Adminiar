	...
	$ip = getClientIP();
  	...
  	{   
		...
		if($count == 1)
		{
	    	...
	    	$sql = "UPDATE terms SET heading = :heading, content = :content, ip = :ip, modified_date = now() WHERE user_id = :user_id";
	    ...
	    {
	    	$sql = "INSERT INTO terms (user_id, heading, content ,ip,created_date) VALUES (:user_id, :heading, :content, :ip, now())";
	    	$stmt = $db_con->prepare($sql);
