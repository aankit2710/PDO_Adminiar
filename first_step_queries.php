...
require_once('includes/config/db_config.php');
	...
	try
  	{
  		$stmt = $db_con->prepare("SELECT * FROM first_step_inquiries WHERE user_id=:user_id");  
...
<head>
	...
	<title>First Step Inquiries</title>
			...
			<div class="content-header row">
				<div class="content-header-left col-12 mb-2 mt-1">
					<div class="row breadcrumbs-top">
						<div class="col-12">
							<h5 class="content-header-title float-left pr-1 mb-0">First Step Inquiries</h5>
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb p-0 mb-0">
									<li class="breadcrumb-item"><a href="index.php"><i class="bx bx-home-alt"></i></a>
									</li>
									<li class="breadcrumb-item active"> First Step Inquiries
									</li>
								</ol>
							</div>
						</div>
			...
			swal({
				...
				preConfirm: function() {
					return new Promise(function(resolve) {
						$.ajax({
							url: "ajax/delete-first-step-async.php",
							method:'POST',
							data: {id:id},
							dataType: 'json',
