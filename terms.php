	...
	try
  	{   
		...
		$content = '';
  		...
  		$stmt = $db_con->prepare("SELECT * FROM terms WHERE user_id=:user_id");  
			...
			<div class="content-header row">
				<div class="content-header-left col-12 mb-2 mt-1">
					<div class="row breadcrumbs-top">
						<div class="col-12">
							<h5 class="content-header-title float-left pr-1 mb-0">Terms and Conditions</h5>
					...
					<div class="row">
						<div class="col-12">
					        ...
					        <div class="card-content">
					          <div class="card-body">
					            <form class="form form-vertical" name="terms" id="terms" method="post">
					              <div class="form-body">
					                <div class="row">
					                  <div class="col-12">
	...
	<script type='text/javascript'>
		$(document).ready(function(){
			$('#terms').submit(function(event) {
				...
				var form = $(this)
				var formData = new FormData($('form[name="terms"]')[0]);
				swal({
					type: 'warning',
					title: 'Are You Sure',
					...
					preConfirm: function() {
						return new Promise(function(resolve) {
							$.ajax({
								url: "ajax/update-term-async.php",
								method:'POST',
								data: formData,
								contentType: false,
								cache: false,
