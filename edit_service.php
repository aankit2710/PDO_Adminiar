...
try
{
	...
	$stmt = $db_con->prepare("SELECT * FROM services WHERE user_id=:user_id AND service_id = :id");  
	...
	if($count == 0)
	{
		echo '<script>alert("Service Is Not existed!");window.location="our_services.php"</script>';
	}
	...
	foreach ($row as $key => $data)
	{
		...
		$service_pic = $data['service_image'];
	}
}
			...
			<div class="content-header row">
				<div class="content-header-left col-12 mb-2 mt-1">
					<div class="row breadcrumbs-top">
						<div class="col-12">
							<h5 class="content-header-title float-left pr-1 mb-0">Edit Program Details</h5>
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb p-0 mb-0">
									<li class="breadcrumb-item"><a href="index.php"><i class="bx bx-home-alt"></i></a>
									</li>
									<li class="breadcrumb-item active"> Edit Program Details
									</li>
								</ol>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-6" style="margin:auto;">
					        ...
					        <div class="card-header">
					          <h4 class="card-title">Update Program Details From Here</h4>
					          <hr/>
					        </div>
					                ...
					                <div class="row">
					                    <div class="col-12">
											<div class="rounded mr-75 col-12" id="preview_pic" style="width: auto;height: auto;text-align:center">
											    <img src='<?=($service_pic)?"../uploads/our_services/$service_pic":"https://www.itl.cat/pngfile/big/222-2223346_blue-pink-plain-background.jpg"?>' alt="avatar" class="img-fluid">
											</div>
										</div>
					                  ...
					                  <div class="col-12">
					                    <div class="form-group">
					                        ...
					                        <input type="text" id="name" class="form-control" name="service_name" placeholder="Service Name" value="<?=$service_name?>">
					                  ...
					                  <div class="col-12">
					                    <div class="form-group">
					                        ...
					                        <input type="text" id="category_name" class="form-control" name="category_name" placeholder="Program Name" value="<?=$category_name?>">
					                        <span class="text-danger" id="ercategory_name"></span>
					                    </div>
					                  </div>
					                  <div class="col-12">
					                    <div class="form-group">
					                        <label for="name-vertical">Category Name</label>
					                        <input type="text" id="program_name" class="form-control" name="program_name" placeholder="Program Name" value="<?=$program_name?>">
				...
				swal({
					...
					preConfirm: function() {
						return new Promise(function(resolve) {
							$.ajax({
								url: "ajax/update-service-async.php",
								method:'POST',
								data: formData,
								contentType: false,
								cache: false,
