	...
	try
  	{   
		...
		$content = '';
  		...
  		$stmt = $db_con->prepare("SELECT * FROM faqs WHERE user_id=:user_id");  
							...
							<div class="accordion" id="accordionWrapa1">
							    <div class="card collapse-header">
							      <div id="heading1" class="card-header text-center" role="tablist" data-toggle="collapse" data-target="#accordion1"
							        ...
							        <span class="collapse-title">Add Faqs From Here</span>
							      </div>
							      <div id="accordion1" role="tabpanel" data-parent="#accordionWrapa1" aria-labelledby="heading1" class="collapse">
							        <div class="card-content">
							          <div class="card-body">
							          	<form class="form form-vertical"  name="faq" id="faq" method="post">
							              	<div class="form-body">
								                <div class="row">
								                  	<div class="col-12">
				                            ...
				                            <table class="table zero-configuration table-bordered">
				                                ...
				                                <tbody>
				                                    ...
				                                    <tr>
				                                        <td><?=$i?></td>
				                                        <td><?=$heading?></td>
				                                        <td><?=substr(html_entity_decode($content),0,80)?></td>
				                                        <td>
				                                        	<a href="edit_faq.php?id=<?=$faq_id?>" class="btn btn-outline-primary btn-sm mr-1 mb-1">Edit</a>
				                                        	<button type="submit" class="btn btn-outline-danger btn-sm mr-1 mb-1 faq_remove" name="delete" id="<?=$faq_id?>">Delete</button>
				                                        </td>
				                                    </tr>
				                                <?php $i++; } } else { ?>
				                                	<tr>
				                                        <td colspan="4" class="text-center">No Faqs Available Yet!</td>
				                                    </tr>
				                                <?php }?>
				                            </table>
				                        </div>
	...
	<script type='text/javascript'>
		$(document).ready(function(){
			$('#faq').submit(function(event) {
				...
				var form = $(this)
				var formData = new FormData($('form[name="faq"]')[0]);
				swal({
					type: 'warning',
					title: 'Are You Sure',
