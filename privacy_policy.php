	...
	try
  	{   
		...
		$content = '';
  		...
  		$stmt = $db_con->prepare("SELECT * FROM privacy_policy WHERE user_id=:user_id");  
...
<head>
			...
			<div class="content-header row">
				<div class="content-header-left col-12 mb-2 mt-1">
					<div class="row breadcrumbs-top">
						<div class="col-12">
							<h5 class="content-header-title float-left pr-1 mb-0">Privacy Policy</h5>
					...
					<div class="row">
						<div class="col-12">
					        ...
					        <div class="card-content">
					          <div class="card-body">
					            <form class="form form-vertical" name="privacy_policy" id="privacy_policy" method="post">
					              <div class="form-body">
					                <div class="row">
					                  <div class="col-12">
	...
	<script type='text/javascript'>
		$(document).ready(function(){
			$('#privacy_policy').submit(function(event) {
				event.preventDefault();
				for ( instance in CKEDITOR.instances ) {
					CKEDITOR.instances[instance].updateElement();
				}
				var form = $(this)
				var formData = new FormData($('form[name="privacy_policy"]')[0]);
				swal({
					type: 'warning',
					title: 'Are You Sure',
					...
					preConfirm: function() {
						return new Promise(function(resolve) {
							$.ajax({
								url: "ajax/update-privacy-async.php",
								method:'POST',
								data: formData,
								contentType: false,
								cache: false,
