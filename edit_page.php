...
try
{
	...
	$stmt = $db_con->prepare("SELECT * FROM pages WHERE user_id=:user_id AND page_id = :id");  
	...
	if($count == 0)
	{
		echo '<script>alert("Page Is Not existed!");window.location="our_pages.php"</script>';
	}

	$row = $stmt->fetchAll();
	foreach ($row as $key => $data)
	{
		$service_id = $data['page_id'];
		$service_name = $data['page_name'];
		$content = $data['content'];
		$service_pic = $data['page_image'];
	}
}
			...
			<div class="content-header row">
				<div class="content-header-left col-12 mb-2 mt-1">
					<div class="row breadcrumbs-top">
						<div class="col-12">
							<h5 class="content-header-title float-left pr-1 mb-0">Edit Page Details</h5>
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb p-0 mb-0">
									<li class="breadcrumb-item"><a href="index.php"><i class="bx bx-home-alt"></i></a>
									</li>
									<li class="breadcrumb-item active"> Edit Page Details
									</li>
								</ol>
							</div>
						</div>
					                ...
					                <div class="row">
					                    <div class="col-12">
											<div class="rounded mr-75 col-12" id="preview_pic" style="width: auto;height: auto;text-align:center">
											    <img src='<?=($service_pic)?"../uploads/pages/$service_pic":"https://www.itl.cat/pngfile/big/222-2223346_blue-pink-plain-background.jpg"?>' alt="avatar" class="img-fluid">
											</div>
										</div>
					                  ...
					                  <div class="col-12">
					                    <div class="form-group">
					                        <label for="name-vertical">Page Name</label>
				...
				swal({
					...
					preConfirm: function() {
						return new Promise(function(resolve) {
							$.ajax({
								url: "ajax/update-page-async.php",
								method:'POST',
								data: formData,
								contentType: false,
								cache: false,
