	...
	try
  	{   
		...
		$content = '';
  		...
  		$stmt = $db_con->prepare("SELECT * FROM rates inner join services on rates.service_id = services.service_id WHERE rates.user_id=:user_id");  
			...
			<div class="content-header row">
				<div class="content-header-left col-12 mb-2 mt-1">
					<div class="row breadcrumbs-top">
						<div class="col-12">
							<h5 class="content-header-title float-left pr-1 mb-0">Rates</h5>
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb p-0 mb-0">
									<li class="breadcrumb-item"><a href="index.php"><i class="bx bx-home-alt"></i></a>
									</li>
									<li class="breadcrumb-item active"> Rates
									</li>
								</ol>
							</div>
						</div>
							...
							<div class="accordion" id="accordionWrapa1">
							    <div class="card collapse-header">
							      <div id="heading1" class="card-header text-center" role="tablist" data-toggle="collapse" data-target="#accordion1"
							        ...
							        <span class="collapse-title">Add Rates From Here</span>
							      </div>
							      <div id="accordion1" role="tabpanel" data-parent="#accordionWrapa1" aria-labelledby="heading1" class="collapse">
							        <div class="card-content">
							          <div class="card-body">
							          	<form class="form form-vertical"  name="rates" id="rates" method="post">
							              	<div class="form-body">
								                <div class="row">
								                  	<div class="col-12">
									                      	...
									                      	<select type="text" id="service" class="form-control" name="service">
									                      	    ...
									                      	    try
                                                                {
                                                            		...
                                                            		$row_service = $stmt_service->fetchAll();
									                      	        ...
									                      	        {
									                      	    ?>
									                      	            <option value="<?=$row_service['service_id']?>"><?=$row_service['service_name']?></option>
									                      	    <?php
									                      	        }
                                                              	}
                                                              	catch(PDOException $e){
				                            ...
				                            <table class="table zero-configuration table-bordered">
				                                ...
				                                <tbody>
				                                    ...
				                                    <tr>
				                                        ...
				                                        <td><?=$service_name?></td>
				                                        <td>
				                                        	<a href="edit_rates.php?id=<?=$rate_id?>" class="btn btn-outline-primary btn-sm mr-1 mb-1">Edit</a>
				                                        	<button type="submit" class="btn btn-outline-danger btn-sm mr-1 mb-1 remove" name="delete" id="<?=$rate_id?>">Delete</button>
				                                        </td>
				                                    </tr>
				                                <?php $i++; } } else { ?>
				                                	<tr>
				                                        <td colspan="4" class="text-center">No Rates Available Yet!</td>
				                                    </tr>
				                                <?php }?>
				                            </table>
				                        </div>
	...
	<script type='text/javascript'>
		$(document).ready(function(){
			$('#rates').submit(function(event) {
				...
				var form = $(this)
				var formData = new FormData($('form[name="rates"]')[0]);
				swal({
					type: 'warning',
					title: 'Are You Sure',
					...
					preConfirm: function() {
						return new Promise(function(resolve) {
							$.ajax({
								url: "ajax/insert-rates-async.php",
								method:'POST',
								data: formData,
								contentType: false,
								cache: false,
		...
		$(".remove").click(function(){
			...
			swal({
				...
				preConfirm: function() {
					return new Promise(function(resolve) {
						$.ajax({
							url: "ajax/delete-rates-async.php",
							method:'POST',
							data: {id:id},
							dataType: 'json',
							success: function (jSon)
